...
extension LoginViewController {
    ...
    func setupViewLayout() {
        ...
        topContainer.simpleAnchor(top: view.safeTopAnchor, bottom: nil, left: view.leadingAnchor, right: view.trailingAnchor, padding: .zero)
        topContainer.sized(with: .init(width: 0, height: view.bounds.height * 0.25 - (heightOfSafeAreaIphoneX ?? 0)))
        ...
        middleContainer.sized(with: .init(width: 0, height: view.bounds.height * 0.27))
        ...
        bottomContainer.sized(with: .init(width: 0, height: view.bounds.height * 0.48))
        ...
        loginButton.simpleAnchor(top: middleContainer.bottomAnchor, bottom: nil, left: view.leadingAnchor, right: view.trailingAnchor, padding: .init(top: 0, left: 30, bottom: 0, right: 30))
        loginButton.sized(with: .init(width: 0, height: 40 * appProportion))
        ...
        newAccountStackView.simpleAnchor(top: lineView.bottomAnchor, bottom: view.safeBottomAnchor, left: view.leadingAnchor, right: view.trailingAnchor, padding: .zero)
        
        newAccountStack.centeredTo(view: newAccountStack)
        
        lineView.simpleAnchor(top: nil, bottom: newAccountStack.topAnchor, left: bottomContainer.leadingAnchor, right: bottomContainer.trailingAnchor, padding: .init(top: 0, left: 0, bottom: 5, right: 0))
        lineView.sized(with: .init(width: 0, height: 1))
